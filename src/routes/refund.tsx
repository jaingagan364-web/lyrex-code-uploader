...
function RefundPage() {
  return (
    <LegalLayout title="Refund Policy" updated="January 1, 2026">
      ...
      <p>
        Email <a href="mailto:FebilyAI@gmail.com">FebilyAI@gmail.com</a> from the email
      ...
      <h2>7. Contact</h2>
      <p>
        Questions about refunds? Email <a href="mailto:FebilyAI@gmail.com">FebilyAI@gmail.com</a>.
      </p>
    </LegalLayout>
  );
}
